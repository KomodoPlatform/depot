...
/home/ubuntu/node_modules/bitcore-node-komodo/bin/bitcore-node create KMD-explorer
cd KMD-explorer
/home/ubuntu/node_modules/bitcore-node-komodo/bin/bitcore-node install git+https://git@github.com/DeckerSU/insight-api-komodo git+https://git@github.com/DeckerSU/insight-ui-komodo
cd /home/ubuntu

cat << EOF > /home/ubuntu/KMD-explorer/bitcore-node.json
{
  "network": "mainnet",
  "port": 3001,
  "services": [
...
cat << EOF > /home/ubuntu/KMD-explorer-start.sh
#!/bin/bash

export NVM_DIR="/home/ubuntu/.nvm"
[ -s "/home/ubuntu/.nvm/nvm.sh" ] && . "/home/ubuntu/.nvm/nvm.sh" # This loads nvm

cd /home/ubuntu/KMD-explorer
